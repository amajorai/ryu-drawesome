...
- Open the same editor from the chat composer and attach a fresh PNG sketch to the next message.
- Annotate uploaded or generated images from their lightbox, with the source image composited under the marks.
...
<a href="https://github.com/amajorai/ryu-drawesome/stargazers">
  <picture>
